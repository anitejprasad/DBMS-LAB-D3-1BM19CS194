...
insert into bank_customer values ('Dhruv', 'Bannergatta_Road', 'Bangalore');
...
insert into bank_customer values ('Rahul', 'Prithviraj_Road', 'Delhi');
commit;
...
from depositor d,bank_account a
where d.accno=a.accno
and a.branch_name='SBI_ParliamentRoad'
